...
public class RpcDemoConsumerApplication {
    ...
    private void testAll() {
        ...
        System.out.println("RPC result userService.findById(1, \"jiajia\") = " + user1);
        ...
        System.out.println("userService.getId(new User(100,\"KK\")) = " + userService.getId(new User(100,"KK")));
